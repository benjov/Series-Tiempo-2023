...
### Arreglos de datos de multiples datos

Generalmente necesitamos utilizar objetos que contengan multiples datos, para este efecto existen los vectores y las columnas, en ambos casos los podemos generar con la función **c()** (combine) que nos ayuda a combinar distintos objetos dentro de uno solo:
...
-   list: objetos que pueden contener multiples tipos de datos, son objetos de tipo *list* y los generamos con la función que leva este nombre(list())
